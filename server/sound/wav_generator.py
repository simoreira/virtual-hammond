...
class WavGenerator(object):
    def __init__(self, organ_registry, rtttl, effects = ['none']):
    ...
    def create(self, filename):
        filename = os.path.abspath(os.path.join(os.path.dirname(__file__), '../storage/wave_files/' + filename + '.wav'))
...
if __name__ == '__main__':
    gerador = WavGenerator('888888888','Barbie girl:d=4,o=5,b=125:8g#,8e,8g#,8c#6,a,p,8f#,8d#,8f#,8b,g#,8f#,8e,p,8e,8c#,f#,c#,p,8f#,8e,g#,f#', ['echo','tremolo'])
    gerador.create("teste_barbie_echo_tremolo")